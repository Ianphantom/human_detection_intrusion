...
def run_camera():
    ...
    while True:
        ...
        if detection_on and current_time >= detection_pause_until:
            ...
            for *box, conf, cls in results.xyxy[0]:
                if int(cls) == 0:
                    ...
                    # Optional: Save cropped detection or draw bounding box (even if not shown)
                    ...
                    if notification_feature_on and not alert_acknowledged and (current_time - last_alert_time > REMINDER_INTERVAL):
                        ...
                        detection_pause_until = current_time + 10
        ...
        print(f"FPS: {fps:.2f}")  # Headless: log instead of show
